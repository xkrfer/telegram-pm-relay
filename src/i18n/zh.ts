...
🎛️ 全局配置：
• /setting view - 查看当前配置
• /setting types <类型列表> - 设置允许的消息类型
• /setting edit <on|off> - 编辑通知开关

🛡️ 内容过滤：
• /filter list - 列出所有过滤规则
...
• ai - AI 智能验证`,
    ...
    userInfoAttempts: (attempts, remaining) => {
      const remainingText =
        remaining !== undefined ? ` (剩余 ${remaining}/3)` : "";
